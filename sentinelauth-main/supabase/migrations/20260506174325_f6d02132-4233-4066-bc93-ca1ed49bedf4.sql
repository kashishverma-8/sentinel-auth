...
CREATE INDEX idx_login_history_user ON public.login_history(user_id, logged_in_at DESC);
...
CREATE POLICY "Admins can view all login history"
  ON public.login_history FOR SELECT USING (public.has_role(auth.uid(), 'admin'));
